"""
Django settings for adfg_42741 project.
...
WSGI_APPLICATION = 'adfg_42741.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "adfg_42741 API",
    "DESCRIPTION": "API documentation for adfg_42741 App",
    "VERSION": "v1",
}
